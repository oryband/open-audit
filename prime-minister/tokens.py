...
TOKEN_TOC_CHAPTER_NUMBER_WITH_TITLE_CROSS_OFFICE = 'TOKEN_TOC_CHAPTER_NUMBER_WITH_TITLE_CROSS_OFFICE'
TOKEN_TOC_CHAPTER_NUMBER_WITH_TITLE_START = 'TOKEN_TOC_CHAPTER_NUMBER_WITH_TITLE_START'
TOKEN_TOC_CHAPTER_NUMBER_WITH_TITLE_CONTINUE = 'TOKEN_TOC_CHAPTER_NUMBER_WITH_TITLE_CONTINUE'

TOKEN_TOC_CHAPTER_OFFICE = 'TOKEN_TOC_CHAPTER_OFFICE'

TOKEN_TOC_CHAPTER_ITEM_ONE_LINE = 'TOKEN_TOC_CHAPTER_ITEM_ONE_LINE'
TOKEN_TOC_CHAPTER_ITEM_MULTI_LINE_START = 'TOKEN_TOC_CHAPTER_ITEM_MULTI_LINE_START'
TOKEN_TOC_CHAPTER_ITEM_MULTI_LINE_CONTINUE = 'TOKEN_TOC_CHAPTER_ITEM_MULTI_LINE_CONTINUE'
TOKEN_TOC_CHAPTER_ITEM_MULTI_LINE_END = 'TOKEN_TOC_CHAPTER_ITEM_MULTI_LINE_END'

# chapter topics
TOKEN_SUMMARY_HEADER = 'TOKEN_SUMMARY_HEADER'  # "תקצירים"

TOKEN_CHAPTER_NUMBER = 'TOKEN_CHAPTER_NUMBER'  # "פרק ראשון"
